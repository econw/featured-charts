...
var group2001 = L.layerGroup();
	var layer2001 = L.mapbox.tileLayer('econw.7r3wsdmt', {reuseTiles: true}).addTo(group2001);
	var grid2001 = L.mapbox.gridLayer('econw.7r3wsdmt').addTo(group2001);
	
var group2002 = L.layerGroup();
	var layer2002 = L.mapbox.tileLayer('econw.7r3wsdmt', {reuseTiles: true}).addTo(group2002);
	var grid2002 = L.mapbox.gridLayer('econw.7r3wsdmt').addTo(group2002);

var group2003 = L.layerGroup();
	var layer2003 = L.mapbox.tileLayer('econw.7r3wsdmt', {reuseTiles: true}).addTo(group2003);
	var grid2003 = L.mapbox.gridLayer('econw.7r3wsdmt').addTo(group2003);

var group2004 = L.layerGroup();
	var layer2004 = L.mapbox.tileLayer('econw.7r3wsdmt', {reuseTiles: true}).addTo(group2004);
	var grid2004 = L.mapbox.gridLayer('econw.7r3wsdmt').addTo(group2004);

var group2005 = L.layerGroup();
	var layer2005 = L.mapbox.tileLayer('econw.7r3wsdmt', {reuseTiles: true}).addTo(group2005);
	var grid2005 = L.mapbox.gridLayer('econw.7r3wsdmt').addTo(group2005);

var group2006 = L.layerGroup();
	var layer2006 = L.mapbox.tileLayer('econw.7r3wsdmt', {reuseTiles: true}).addTo(group2006);
	var grid2006 = L.mapbox.gridLayer('econw.7r3wsdmt').addTo(group2006);

var group2007 = L.layerGroup();
	var layer2007 = L.mapbox.tileLayer('econw.7r3wsdmt', {reuseTiles: true}).addTo(group2007);
	var grid2007 = L.mapbox.gridLayer('econw.7r3wsdmt').addTo(group2007);

var group2008 = L.layerGroup();
	var layer2008 = L.mapbox.tileLayer('econw.7r3wsdmt', {reuseTiles: true}).addTo(group2008);
	var grid2008 = L.mapbox.gridLayer('econw.7r3wsdmt').addTo(group2008);

 //load global variables
	...
	//add maps menu
	map.addControl(new uiControl('#map-info', { position: 'topleft' }));

	//funtionality for refreshing map view
	$("#homeButton").click(function() {
		map.setView([45.467021, -122.675738], 11);
	});
...
function loadAffordability20() {
    ...
    document.getElementById('legend').innerHTML = "<img id='affordLegend' class='afford20 img-responsive' src='images/legend_affordability.png' alt='affordability legend'></img>";
...
function loadVulnerability(){
    ...
    document.getElementById('legend').innerHTML = "<img id='vIndexLegend' class='img-responsive' src='images/legend_vIndex.png' alt='affordability legend'></img>";
	...
	function setStyle(){
		...
		vulnerability.eachLayer(function(layer){
			...
			var vulnField= 'SC_TOT';
			//conditional statement for hex bin color classification
			if(attr[vulnField + year] === 0){
				layer.setStyle({
					fillColor:"rgb(235,235,235)"
				});
			}else if(attr[vulnField + year]=== 1){
				layer.setStyle({
					fillColor:"rgb(254,229,217)"
				});
			
			}else if(attr[vulnField + year] === 2){
				layer.setStyle({
					fillColor:"rgb(252,174,145)"
				});
			
			}else if(attr[vulnField + year] === 3){
				layer.setStyle({
					fillColor:"rgb(251,106,74)"
				});
			
			}else if(attr[vulnField + year] === 4){
				layer.setStyle({
...
function loadOwnership() {
    ...
    document.getElementById('legend').innerHTML = "<img id='ownLegend' class='img-responsive' src='images/legend_ownership.png' alt='affordability legend'></img>";
